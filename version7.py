...
hyperparams = {
    'smell_thr_values': [1, 3, 5, 8, 10, 12, 15, 18, 20, 22, 25, 28, 30, 40, 50],
    'smell_predict_hrs_values': [2,4, 6, 8, 10, 12, 15, 18],
    'look_back_hrs_values': [1, 2, 3, 4, 5, 6, 7, 8, 9],
    'add_inter_values': [False],
    'test_size_values': [1000, 1500, 2680, 3000],
    'train_size_values': [4000, 5000, 6360, 7000]
}
models = [DummyClassifier(), DecisionTreeClassifier(), RandomForestClassifier(n_jobs=-1)]
